...
(define-predicate has-port (procedure-type direction-or-branch-name port-name) (no-variables-in-data-mixin ltms:ltms-predicate-model))
...
(define-predicate has-branch-port (procedure-type branch-name port-name) (no-variables-in-data-mixin ltms:ltms-predicate-model))
(define-predicate has-join-port  (procedure-type join-name port-name) (no-variables-in-data-mixin ltms:ltms-predicate-model))
